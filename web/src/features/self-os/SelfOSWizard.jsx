...
const STEP_CONTAINER_STYLE = { display: "grid", gap: "1.1rem" };
...
function StepHeader({ step, title, children }) {
  return (
    <div style={{ marginBottom: children ? "0.25rem" : "0" }}>
      <ProgressLabel step={step} />
      <h3 style={STEP_TITLE_STYLE}>{title}</h3>
      {children}
    </div>
  );
}
...
export default function SelfOSWizard({ initialProfile = null, onCancel, onComplete }) {
  ...
  if (step === 0) {
    return (
      <div style={STEP_CONTAINER_STYLE}>
        <StepHeader step={step} title="Let's tune HumanOS to your inner world" />
        <p
          style={{
            fontSize: "0.98rem",
            lineHeight: 1.7,
  ...
  if (step === 1) {
    return (
      <div style={STEP_CONTAINER_STYLE}>
        <StepHeader step={step} title="Values - Selection">
        ...
        <div style={{ ...NAV_ROW_STYLE, marginTop: "1rem" }}>
  ...
  if (step === 2) {
    return (
      <div style={STEP_CONTAINER_STYLE}>
        <StepHeader step={step} title="Values - Ranking">
          <HelperText>
  ...
  if (step === 3) {
    return (
      <div style={STEP_CONTAINER_STYLE}>
        <StepHeader step={step} title="Personality Style - Sliders">
          <HelperText>
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <div style={{ color: "#94a3b8", fontSize: "0.9rem", flex: 1 }}>{dim.description}</div>
  ...
  if (step === 4) {
    ...
    return (
      <div style={STEP_CONTAINER_STYLE}>
        <StepHeader step={step} title="Energy Rhythms">
          <HelperText>
        ...
        <div>
          <h4 style={{ fontSize: "1.05rem", color: "#e5e7eb", marginBottom: "0.5rem" }}>Social energy</h4>
  ...
  if (step === 5) {
    ...
    return (
      <div style={STEP_CONTAINER_STYLE}>
        <StepHeader step={step} title="Life Context & Flags">
          <HelperText>
  ...
  if (step === 6) {
    ...
    return (
      <div style={STEP_CONTAINER_STYLE}>
        <StepHeader step={step} title="Summary & Confirmation">
        ...
        <div style={{ ...NAV_ROW_STYLE, marginTop: "0.5rem" }}>
